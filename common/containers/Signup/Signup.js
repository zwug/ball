    ...
    return (
      <div className={s.container}>
        ...
        <div className={s.sellingText}>
          <p>Тематический весенний бал в Измайловском кремле.</p>
          {this.sex !== 'm' &&
            <p className={s.question}>Ты давно хотела оказаться в сказочном месте и чтобы тебя закружили в вальсе уверенные руки партнёра?</p>}
          {this.sex !== 'f' &&
            <p className={s.question}>Ты давно хотел попасть туда, где тебя будут окружать 60 прекрасных дам, с которыми ты сможешь познакомиться?</p>}
          <p>Мы решили воплотить твои желания в реальность!<br>21 мая в Измайловском кремле состоится самый запоминающийся бал весны.</p>
          <p>Ты уже сейчас можешь вспоминать любимого героя из мультфильмов или сказок, в образе которого ты хочешь оказаться, ведь наш бал тематический!<br>29 марта начало репетиций, на которых вас всему научат, чтобы уверенно чувствовать себя на паркете!</p>
